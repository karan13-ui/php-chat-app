  ...
  <div class="col-sm-8">
    <form action="" method="post" enctype="multipart/form-data">
          <table class="table table-bordered table-hover">
            ...
            <tr><td style="font-weight: bold;">Change Your Profile Picture</td><td><a class="btn btn-default" style="text-decoration: none;font-size: 15px;" href="upload.php"><i class="fa fa-user" aria-hidden="true"></i> Change Profile</a></td></tr>
            ...
            <tr>
              <td style="font-weight: bold;">Forgotten Password Recovery Option</td>
              <td>
            ...
            <tr><td style="font-weight: bold;">Change Password</td><td><a class="btn btn-default" style="text-decoration: none;font-size: 15px;" href="change_password.php"><i class="fa fa-key fa-fw" aria-hidden="true"></i> Change Password</a></td></tr>

...
<div class="signin-form">
    <form action="" method="post">
		...
		<div class="form-group">
			<label>Email</label>
        	<input type="text" class="form-control" placeholder="Email" name="email" autocomplete="off" required="required">
        </div>
        <div class="form-group">
			<label>Best Friend Name</label>
            <input type="text" class="form-control" placeholder="Name" name="bf" autocomplete="off" required="required">
        </div>
		<div class="form-group">
